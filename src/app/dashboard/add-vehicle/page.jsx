"use client"
import { Button, DatePicker, Input, Modal, ModalBody, ModalContent, ModalFooter, Select, SelectItem, useDisclosure } from "@nextui-org/react";
            ...
            <div className="w-full">
                ...
                <div className="mt-8 flex w-full">
                    <div className="w-3/4 pr-6">
                        <div className="w-full grid grid-cols-2 gap-x-12 gap-y-4">
                            <DatePicker
                                isRequired
                            ...
                            <Select
                                ...
                                onChange={setCr}
                            >
                                <SelectItem key={1} className="rounded-lg hover:bg-[#ebebeb]">Pending</SelectItem>
                                <SelectItem key={2} className="rounded-lg hover:bg-[#ebebeb]">Ok</SelectItem>
                            </Select>
                        </div>
                        
                        <div className="w-full grid grid-cols-2 gap-x-12 gap-y-4 mt-12">
                            <Input
                                isRequired
                                isClearable
